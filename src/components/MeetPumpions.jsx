...
const MeetPumpions = () => {
  return (
      ...
      <div className="container max-w-[1140px] mx-auto w-full bg-cover  pb-11 relative">
        <Image
          width={9999}
          height={333}
          src="/assets/images/png/meet-bg.png"
          alt="img bg"
          className="absolute min-h-[333px] w-full max-lg:min-h-[318px] max-md:min-h-[530px] px-4"
        />
        <div className=" w-full max-sm:px-3   bg-no-repeat flex flex-col bg-cover max-md:h-[530px] justify-center items-center py-14 xl:w-[1140px] lg:w-[770px]  xl:h-[333px] h-[318px] mx-auto overflow-hidden">
