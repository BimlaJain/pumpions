  ...
  return (
      <div id='home' className="bg-[url('/assets/images/png/hero-bg.png')] bg-cover bg-no-repeat bg-center lg:h-[853px] md:h-[641px] h-[444px] relative overflow-hidden">
          ...
          <div className='absolute lg:left-[1%] md:-left-[10%] -left-[35%] lg:top-[18%]'>
              <Image src="/assets/images/png/left-cloud.png" alt='left-cloud' width={166} height={85}  className='pointer-events-none'/>
              </div>
          <div className='absolute lg:right-[1%] md:-right-[3%] -right-[30%] lg:top-[18%] top-[16%] '> 
              <Image src="/assets/images/png/right-cloud.png" alt='right-cloud' width={166} height={85} className='pointer-events-none'/>
          </div>
          <div className="container max-w-[1140px] mx-auto px-4">
              <Image src="/assets/images/png/hero-heading.png" alt='hero-heading' width={899} height={225} className='xl:max-w-[899px] md:max-w-[612px] max-w-[282px] pb-[26px] mx-auto pt-[71px] pointer-events-none' />
