    ...
    return (
        <div className='bg-[#28424F] relative z-10 overflow-hidden'>
                ...
                <div className="flex max-lg:flex-wrap lg:justify-between justify-center items-center">
                    <div className='md:w-[892px] md:h-[381px] w-[366px] h-[181px] pl-4'>
                        <Image src="/assets/images/png/sunsetclub.png" alt='sunset club' width={831} height={381} />
                    </div>

                    <div className='flex flex-col gap-2 justify-center items-center  lg:mr-auto px-4'>
                        <div className="flex gap-2">
                            {CLUB_DATA.map((item, i) => (
                                <div key={i} className="flex gap-2 justify-between items-center overflow-hidden group">
                                    <div className="flex w-[181px] h-[200px] flex-col justify-center p-6 items-center  bg-[url('/assets/images/png/border.png')] overflow-hidden  bg-cover group-hover:bg-[url('/assets/images/png/border-orange.png')] ">
