    ...
    return (
        <div id='team' className='lg:pt-[183px] md:pt-[130px] pt-[66px]'>
            <div className="container max-w-[1140px] mx-auto px-4">
                <h2 className='lg:text-[32px] text-2xl font-normal leading-[204%] lg:pb-20 md:pb-[75px] pb-[30px] text-center text-white'>OG PUMPIONS</h2>
                        ...
                        {OG_PUMPIONS_DATA.map((item, i) => (
                            <SwiperSlide key={i}>
                                <div className='text-center max-sm:pb-16'>
                                    ...
                                    <p className='text-base font-normal leading-[202%] text-white/70'>{item.work}</p>
                ...
                <div className='hidden sm:flex flex-wrap lg:justify-between max-sm:gap-8 items-center justify-center'>
                    {OG_PUMPIONS_DATA.map((item, i) => (
                        <div key={i} className={`max-lg:mb-12 ${i % 2 === 0 ? 'max-lg:mr-[141px] max-md:mr-0' : 'max-lg:mr-0'}`}>
                            ...
                            <p className='text-base font-normal leading-[202%] text-white/70 text-center'>{item.work}</p>
